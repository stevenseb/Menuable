      ...
      <div className={styles.buttonContainer}>
        <button
          className={`${styles.viewButton} ${
            currentView === "addItem" ? styles.activeButton : ""
          }`}
        ...
        <button
          className={`${styles.viewButton} ${
            currentView === "editMenu" ? styles.activeButton : ""
          }`}
        ...
        <button
          className={`${styles.viewButton} ${
            currentView === "inventory" ? styles.activeButton : ""
          }`}
        ...
        <button
          className={`${styles.viewButton} ${
            currentView === "routes" ? styles.activeButton : ""
          }`}
